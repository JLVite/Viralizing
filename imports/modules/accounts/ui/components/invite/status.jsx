...
class InviteStatus extends React.Component {
  ...
  render() {
    let { manager, userId, account, invite, refetch, isOwner } = this.props;
    return (
      <div className="row">
        <AccountInvite manager={manager} userId={userId} account={account} hasInvite={invite ? true : false}
