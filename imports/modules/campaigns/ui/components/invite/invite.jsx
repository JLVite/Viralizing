...
class CampaignInvite extends React.Component {
  constructor() {
    super();
            ...
            <div className="form-avatar">
              ...
              <div className="title">
                {this.props.userId === manager._id ? <Translate
                  value={getTranslation('form.manager.youAre')}/> : (managerName === ' ' ? (manager.emails && manager.emails[0] ? manager.emails[0].address : managerName) : managerName)}
        ...
        {this.state.form && (
          <div>
            ...
            <div className="col-md-4">
              <a className="btn btn-primary" style={{marginTop:'29px',height:'38px',padding:"5px 10px"}} onClick={this.sendInvite}>
