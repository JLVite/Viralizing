...
const renderLink = function (cell, row) {   // String example
  return <Link to={'/campaigns/edit/' + cell}><i className="icon wb-edit" aria-hidden="true"/></Link>;
};
...
const renderUser = function (cell, row) {   // String example
  ...
  return (
    <Link to={'/campaigns/edit/' + row._id}>
...
const renderCampaign = function (cell, row) {   // String example
  return (
    <Link to={'/campaigns/edit/' + row._id}>
      {cell}
    </Link>
        ...
        <div className="row">
          <div className="col-md-12">
            <button className="btn btn-primary table-button" onClick={this.props.new}>
              <Translate value="Campaigns.list.new"/>
            </button>
          </div>
        </div>
        {
            ...
            :
              <div className="ibol-table">
                <BootstrapTable data={list} options={options} pagination search
                  ...
                  <TableHeaderColumn dataField='name' dataFormat={renderCampaign} dataSort={true} width="250px"><Translate
                    value={getTranslation('table.headers.campaigns')}/></TableHeaderColumn>
                  ...
                  <TableHeaderColumn dataField='shares' dataFormat={renderShares} width="200px"><Translate
                    value={getTranslation('table.headers.shares')}/></TableHeaderColumn>

                  <TableHeaderColumn dataField='name' dataFormat={renderInfluencers} dataSort={true} width="250px"><Translate
                    value={getTranslation('table.headers.influencers')}/></TableHeaderColumn>
                  ...
                  <TableHeaderColumn dataField='name' dataFormat={renderBudget} dataSort={true} width="200px"><Translate
                    value={getTranslation('table.headers.budget')}/></TableHeaderColumn>
                </BootstrapTable>
              </div>
        }
